...
class Qlearner:
    ...
    def calcReward(self):
        ...
        c2 = 0.1
        c3 = -1
        return (c1*self.vel + c2*self.laserReading[1])# + c3*(self.laserReading[0]-self.laserReading[2])) #sum(c2*self.laserReading[0]))  # + c3*reset
